        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductionLine = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaterialId = table.Column<int>(type: "int", nullable: false),
                    Meterage = table.Column<double>(type: "float", nullable: false),
                    RunNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CuttingStatements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CuttingStatements_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CuttingStatements_Materials_MaterialId",
                        column: x => x.MaterialId,
                        principalTable: "Materials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CuttingStatements_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CuttingStatements_WorkOrders_WorkOrderId",
                        column: x => x.WorkOrderId,
                        principalTable: "WorkOrders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CuttingStatements_Workers_WorkerId",
                        column: x => x.WorkerId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MaterialRequisitionId = table.Column<int>(type: "int", nullable: false),
                    MaterialId = table.Column<int>(type: "int", nullable: false),
                    Quantity = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MaterialRequisitionDetails_Materials_MaterialId",
                        column: x => x.MaterialId,
                        principalTable: "Materials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CuttingStatements_CustomerId",
                table: "CuttingStatements",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_CuttingStatements_MaterialId",
                table: "CuttingStatements",
                column: "MaterialId");

            migrationBuilder.CreateIndex(
                name: "IX_CuttingStatements_ProductId",
                table: "CuttingStatements",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_CuttingStatements_WorkerId",
                table: "CuttingStatements",
                column: "WorkerId");

            migrationBuilder.CreateIndex(
                name: "IX_CuttingStatements_WorkOrderId",
                table: "CuttingStatements",
                column: "WorkOrderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaterialRequisitionDetails_MaterialId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesOrderDetails_WorkOrderId",
                table: "SalesOrderDetails",
                column: "WorkOrderId");
