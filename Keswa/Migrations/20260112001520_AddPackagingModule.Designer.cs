...
namespace Keswa.Migrations
{
    ...
    [Migration("20260112001520_AddPackagingModule")]
    partial class AddPackagingModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Keswa.Models.FinishingAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("FinishingBatchId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FinishingBatchId");

                    b.HasIndex("WorkerId");

                    b.ToTable("FinishingAssignments");
                });

            modelBuilder.Entity("Keswa.Models.FinishingBatch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("FinishingBatchNumber")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("FinishingBatches");
                });

            modelBuilder.Entity("Keswa.Models.FinishingProductionLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("FinishingAssignmentId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FinishingAssignmentId");

                    b.ToTable("FinishingProductionLogs");
                });
            ...
            modelBuilder.Entity("Keswa.Models.PackagingAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("PackagingBatchId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PackagingBatchId");

                    b.HasIndex("WorkerId");

                    b.ToTable("PackagingAssignments");
                });

            modelBuilder.Entity("Keswa.Models.PackagingBatch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PackagingBatchNumber")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("QualityBatchId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("QualityBatchId");

                    b.HasIndex("WorkOrderId");

                    b.ToTable("PackagingBatches");
                });
            ...
            modelBuilder.Entity("Keswa.Models.Product", b =>
                {
                    ...
                    b.Property<decimal>("FinishingFee")
                        .HasColumnType("decimal(18, 2)");
            ...
            modelBuilder.Entity("Keswa.Models.QualityAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ReceivedQuantityGradeA")
                        .HasColumnType("int");

                    b.Property<int>("ReceivedQuantityGradeB")
                        .HasColumnType("int");
                    ...
                    b.ToTable("QualityAssignments");
                });

            modelBuilder.Entity("Keswa.Models.QualityBatch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("QualityBatchNumber")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Keswa.Models.FinishingAssignment", b =>
                {
                    b.HasOne("Keswa.Models.FinishingBatch", "FinishingBatch")
                        .WithMany("FinishingAssignments")
                        .HasForeignKey("FinishingBatchId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Keswa.Models.FinishingProductionLog", b =>
                {
                    b.HasOne("Keswa.Models.FinishingAssignment", "FinishingAssignment")
                        .WithMany("FinishingProductionLogs")
                        .HasForeignKey("FinishingAssignmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("FinishingAssignment");
                });
            ...
            modelBuilder.Entity("Keswa.Models.PackagingAssignment", b =>
                {
                    b.HasOne("Keswa.Models.PackagingBatch", "PackagingBatch")
                        .WithMany()
                        .HasForeignKey("PackagingBatchId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Keswa.Models.PackagingBatch", b =>
                {
                    b.HasOne("Keswa.Models.QualityBatch", "QualityBatch")
                        .WithMany()
                        .HasForeignKey("QualityBatchId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Keswa.Models.WorkerAssignment", b =>
                {
                    ...
                    b.HasOne("Keswa.Models.WorkerPayment", null)
            ...
            modelBuilder.Entity("Keswa.Models.FinishingAssignment", b =>
                {
                    b.Navigation("FinishingProductionLogs");
                });

            modelBuilder.Entity("Keswa.Models.FinishingBatch", b =>
                {
                    b.Navigation("FinishingAssignments");
                });
            ...
            modelBuilder.Entity("Keswa.Models.QualityBatch", b =>
                {
                    b.Navigation("QualityAssignments");
                });
            ...
            modelBuilder.Entity("Keswa.Models.WorkerAssignment", b =>
                {
                    b.Navigation("SewingProductionLogs");
                });
